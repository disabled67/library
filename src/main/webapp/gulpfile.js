...
gulp.task('assets-bundle', function () {

  var jsres = gulp.src('assets/**')
    .pipe(gulp.dest('../resources/static/assets'));
...
gulp.task('default', ['app-bundle', 'copy-css', 'vendor-bundle', 'template-bundle','assets-bundle']);
